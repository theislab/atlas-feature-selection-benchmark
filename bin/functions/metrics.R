...
#' for
#' @param metric_type The type of the metric, either 'IntegrationBatch',
#' 'IntegrationBio', 'Classification', 'Mapping' or 'Unseen'
...
format_metric_results <- function(dataset, method, integration, metric_type,
    ...
    if (!(metric_type %in% c(
        ...
        stop(
            "'metric_type' must be one of 'IntegrationBatch', 'IntegrationBio'",
